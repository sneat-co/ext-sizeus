...
import { IListContext } from '../contexts/index.js';
...
// export abstract class IListService extends ICommuneItemService<IListDto, SizeusAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, SizeusAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<SizeusAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class ISizeusService extends RxStoreService<SizeusAppSchema> {

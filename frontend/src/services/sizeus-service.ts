...
import { ListType } from '../dto/index.js';
import {
  ICreateListRequest,
...
// ISizeusService is the runtime-light contract the template pages and components
...
// SIZEUS_SERVICE token below. The shared BaseListPage additionally needs the
...
export interface ISizeusService {
...
export const SIZEUS_SERVICE = new InjectionToken<ISizeusService>(
  'SizeusService',
);
